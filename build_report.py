...
SOURCES = {
    ...
    "重庆邮电校友会专业": "https://www.cuaa.net/2022index/news/news.jsp?information_id=19906",
    ...
    "重庆理工校友会专业": "https://www.cuaa.net/2022index/news/news.jsp?information_id=19910",
...
reach = [
    Candidate(
        ...
        "信息与通信、计算机是学校核心板块；软科计算机科学与技术学科前12%，校友会专业评级为A类区间。",
...
stable = [
    ...
    Candidate(
        ...
        "重庆南岸/校本部",
        "集成电路类",
        "2025:17490；2024:19109；2023:同类20706",
        "暂未查到可靠公开2026计划；2025普通类138人",
        "学校电子信息平台强，集成电路方向符合第一优先级；但独立专业评级暂未稳定复核到软科B以上，当前主要依托电子信息学科平台判断。",
        "重庆/成都有电子信息、功率半导体、集成电路设计和封测相关岗位。",
        "就业和升学逻辑好，位次匹配；适合愿意考研深造的学生。",
        "本条因专业评级仍需最终核验，建议放在B以上主表靠后；若严格只认软科专业评级，可移入待核池。",
        82,
        "稳妥但需核评级",
        "建议放入但排序不高于软件/电子工程",
        ("重庆邮电历年录取", "重庆邮电软科"),
...
safety = [
    ...
    Candidate(
        ...
        "校友会/第三方专业评级B+；工科就业方向清晰，适合电气、电控、制造业自动化。",
...
def render() -> str:
    ...
    final_order = [
        "前6个：重邮计算机、重邮通信、重邮智能技术、浙工大机器人、江苏大学机械电子、江苏大学机械设计。",
        "第7-14个：重邮电子工程、重邮软件、重邮集成电路、重邮机器人、成信电子信息工程、成信电子信息科学与技术、成信网络工程、浙江理工机械电子。",
        "第15-19个：重庆理工机械电子、智能车辆、电气、车辆、物联网。",
        "待核扩展池：湖北工业电气、中国计量测控/智能感知、上海海事机械电子、南通物联网/通信、北京联合计算机等，只有核到2026计划和B以上评级后再插入。",
    ]
...
<main>
  <section id="conclusion">
    ...
    <div class="callout ok"><b>最稳妥的方向：</b>重庆邮电大学电子工程/软件/集成电路/机器人，成都信息工程大学电子信息/网络工程，重庆理工大学机械电子/智能车辆/电气等。</div>
  ...
  <section id="data">
    ...
    <p><b>相近位次层级：</b>近三年18162位附近，重邮电子工程/软件/集成电路/机器人、成信电子信息与网络方向、浙江理工机械电子、重庆理工强保底专业较常见；重邮计算机/通信、浙工大机器人、江苏大学强机械多为冲刺。</p>
    <div class="ranking">
  ...
  <section id="summary">
    <h2>10. 最后给一个简单版总结</h2>
    <div class="cols">
      <p><b>最值得冲：</b>重邮通信与信息类、重邮计算机、重邮智能技术类、浙江工业机器人工程、江苏大学机械电子、江苏大学机械设计。</p>
      <p><b>最稳：</b>重邮电子工程、重邮软件、重邮集成电路、重邮机器人工程、成信电子信息工程、成信电子信息科学与技术、成信网络工程、浙江理工机械电子。</p>
      <p><b>最适合保底：</b>重庆理工机械电子、智能车辆、电气、车辆、物联网。</p>
      <p><b>不要因校名好听就选：</b>材料、化工、过程装备、交通、土木、环境、生物工程、医学信息工程、数字媒体技术、财经类数据科学。</p>
      <p><b>一句话：</b>586/18162这个分数段，最该做的是“守住强工科专业”，用重邮和成信做主轴，用重庆理工强应用工科保底，少量冲真正强专业，不要用冷门专业换校名。</p>
    </div>
  </section>
