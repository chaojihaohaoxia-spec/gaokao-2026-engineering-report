...
def render() -> str:
    ...
    region_buttons = ["全部", "成渝", "长三角", "珠三角", "京津", "华中", "西北", "青岛大连"]
...
<header>
  <div class="titlebar">
    <div>
      <h1>重庆586分工科志愿清单</h1>
      <p class="subtitle">主逻辑：只看工科，优先B及以上专业方向；按位次、专业实力、城市资源和风险重新排序，不为校名牺牲专业。</p>
    </div>
  ...
  <div class="quick">
    ...
    <div class="metric"><strong>13城</strong><span>成渝、长三角、京津、珠三角等</span></div>
...
<main>
  <section id="list">
    <h2>完整填报清单</h2>
    <p>默认顺序就是建议排序：前段冲强专业，中段抓重邮/西邮/成信/中国计量等匹配项，后段用重庆理工、南京工程、南通等可接受工科保底。</p>
    <div class="toolbar">
